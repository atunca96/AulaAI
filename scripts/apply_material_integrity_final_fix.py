...
# Unit assessment post-publication completion.
...
if s.count(old) != 1:
    raise SystemExit(f"bilingual assessment metadata patch count={s.count(old)}")
s = s.replace(old, new, 1)

# Run a single bounded class-wide IPA completion only if blanks actually exist.
