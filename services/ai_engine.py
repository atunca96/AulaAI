...
"""
    ...
    13. MANDATORY PRE-OUTPUT INTERNAL VERIFICATION (6 EVALUATION GATES):
        ...
        * GATE 3 - NATURALNESS, COLLOCATIONAL INTEGRITY & SEMANTIC SELECTION: Is the target-language wording 100% natural, idiomatic, and examiner-grade in {language}? Are all verbs, arguments, complements, and surrounding phrases authentic in real living usage (e.g. prefer natural constructions such as “Ekibinizi tenzih ederek...” rather than forcing “tenzih etmek” onto an unnatural abstract object)? Are all lexical choices semantically exact for the context rather than superficially formal or misselected (e.g. reject “salahiyet” where “selamet” is required)? (REJECT if awkward, colligationally mismatched, robotic, or using superficially formal but semantically misselected vocabulary).
