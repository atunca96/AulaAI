...
"""
    ...
    12) PRE-OUTPUT 6-GATE SELF-VERIFICATION: Internally verify each question against the 6 gates (Material support, Level fit, Naturalness in context & technical precision, Uniqueness of answer, Distractor plausibility & category matching, Semantic duplication/coverage) before returning JSON. Ensure stems, answers, and distractors are all idiomatic, grammatically valid, functionally plausible, and mutually consistent, with zero artificial wording or misleading terminology. Resolve all issues during generation itself."""
