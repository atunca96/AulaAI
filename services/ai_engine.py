...
"""
     ...
     7. DISTRACTOR PLAUSIBILITY, REALISTIC LEARNER CONFUSIONS & CEFR CALIBRATION (CRITICAL):
        ...
        - HIGH-CALIBER DISTRACTOR RIGOR & NEAR-MISS COMPETITIVENESS (NO EASY FILLERS):
          ...
          * ZERO easy 'throwaway' or filler options that a student can eliminate at a superficial glance without thinking.
           ...
           * LEXICAL HEAD, VALENCY & COMPLEMENT INTEGRITY (STRICT BAN ON MECHANICAL COMPLEMENT TRANSPLANTATION):
             ...
             ABSOLUTELY DO NOT mechanically transplant a modifier, prepositional complement, or argument from one taught item onto an incompatible head word or verb merely because both belong to the same semantic domain or lesson page. Distractors must preserve the natural lexical head, valency, complement type, required preposition/case, and authentic grammatical compatibility of each option.
             If three natural same-category distractors cannot be formed with authentic native collocations, use other authentic, contextually plausible alternatives (e.g. alternative actions, situational reactions, or functional vocabulary) instead of fabricating an unnatural near-miss combination.
    ...
    13. MANDATORY PRE-OUTPUT INTERNAL VERIFICATION (6 EVALUATION GATES):
        ...
        * GATE 5 - PLAUSIBLE SAME-LEVEL DISTRACTORS & NATURAL OPTIONS: Does EVERY single option (the correct answer AND all 3 distractors) stand on its own as a completely natural, grammatically valid, and authentic expression in {language}, with zero malformed or contextually unnatural wording? LEXICAL HEAD, VALENCY & COMPLEMENT INTEGRITY: Distractors must strictly preserve the lexical head, valency, complement type, required preposition/case, grammatical compatibility, and collocational relationships demonstrated by authentic living usage and source-backed examples. ABSOLUTELY DO NOT mechanically transplant a modifier, prepositional complement, or argument from one taught item onto an incompatible head word or verb merely because both belong to the same semantic domain or lesson page. Distractors must preserve the natural lexical head, valency, complement type, required preposition/case, and authentic grammatical compatibility of each option. If three natural same-category distractors cannot be formed with authentic native collocations, use other authentic, contextually plausible alternatives instead of fabricating an unnatural near-miss combination. Every distractor MUST be a real, correctly formed, naturally usable word, phrase, or construction in {language}; NEVER invent, distort, misspell, mechanically alter, or create obviously malformed forms just to make an option incorrect; if natural parallel forms do not exist, use a plausible semantic or functional distractor instead. Stems, answers, and distractors must all be idiomatic, grammatically valid, functionally plausible, and mutually consistent, while avoiding artificial wording, misleading terminology, or options trivially eliminable for the wrong reason. Distractors must be plausible options that compete with the correct answer at the same grammatical, semantic, pragmatic, or register level rather than being trivially eliminable, while strictly ensuring no distractor is also valid for the stem. Distractors must be not only grammatical in isolation, but idiomatically plausible in the exact sentence frame of the prompt. A distractor must be wrong because of meaning, pragmatic fit, or context, NEVER because the option itself is ungrammatical, awkward, invented, or malformed! (ABSOLUTELY REJECT if any distractor is itself grammatically unnatural, malformed, invented, structurally/idiomatically implausible in the sentence frame, or trivially eliminable due to category mismatch). Where appropriate, are at least two distractors plausible near-miss options from the same grammatical or semantic category as the answer?
