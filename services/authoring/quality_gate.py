    ...
    for topic in topics:
        ...
        if blockers or render_blockers:
            ...
            retry = _call_review(
                ...
                max_tokens=3200, effort="none", budget=budget,
            ...
            if still:
                ...
                if remaining_records and any(row.get("repair_paths") for row in remaining_payload):
                    ...
                    exact_retry = _call_review(
                        ...
                        max_tokens=3000, effort="none", budget=budget,
        ...
        if canonical not in ("English", "Turkish"):
            ...
            if missing_pairs:
                ...
                retry = _call_review(
                    model=REPAIR_MODEL, system=_LESSON_REVIEW_SYSTEM, payload=targeted,
                    max_tokens=2800, effort="none", budget=budget,
...
def review_unit_assessment(*, unit_title: str, assessment_topic: Dict[str, Any],
    ...
    if render_blockers:
        ...
        retry = _call_review(
            ...
            payload=retry_payload, max_tokens=3600, effort="none", budget=budget,
    ...
    for unit in units:
        ...
        for topic in topics:
            ...
            if topic.get("is_assessment"):
                ...
                data = _call_review(
                    model=REPAIR_MODEL, system=_ASSESSMENT_REVIEW_SYSTEM,
                    payload=payload, max_tokens=3600, effort="none", budget=budget,
                ...
                data = _call_review(
                    model=REPAIR_MODEL, system=_LESSON_REVIEW_SYSTEM,
                    payload=payload, max_tokens=3400, effort="none", budget=budget,
