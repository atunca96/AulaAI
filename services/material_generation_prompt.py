...
- Uncertainty and VARIATION are different cases, and only the first licenses omission. A form whose pronunciation differs between accepted standard varieties of {language} is not a form you are unsure of: pick the single reference variety you are using for this whole lesson and transcribe it in that variety. Omitting a common word because more than one standard pronounces it differently leaves a hole in a column the reader expects to be complete, which teaches nothing and reads as a defect.
