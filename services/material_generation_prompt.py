...
- Dialogue coherence is checked turn by turn: each reply must naturally answer or advance the immediately preceding utterance. Never write a target-language line whose instructional-language translation expresses a different intended meaning; if they diverge, rewrite the target-language line rather than paraphrasing the translation to hide the mismatch.
