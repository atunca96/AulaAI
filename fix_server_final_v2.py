...
# Locate the function and replace it with the CORRECT function call
...
if start_idx != -1 and end_idx != -1:
    new_func = """    def _get_activity(self, topic_id):
        ...
        from services.ai_engine import ai_generate_activity
        
        # CORRECT FUNCTION CALL: ai_generate_activity
        activities = ai_generate_activity(
            topic_dict['title'], 
            topic_dict.get('type', 'vocabulary'), 
            topic_dict, 
            count=6, 
            language=lang_name
        )
...
"""
    ...
    with open(file_path, 'w', encoding='utf-8', newline='\n') as f:
        f.write(new_content)
    print("Success: Overwrote _get_activity with correct function call")
else:
