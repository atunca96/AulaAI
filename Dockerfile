...
RUN python scripts/patch_pdf_cache_bust_v39.py \
    ...
    && python -m py_compile server.py worker.py runtime_bootstrap.py services/ai_engine.py services/material_generation_prompt.py services/pronunciation_lexicon.py services/bilingual_finisher.py services/pdf_renderer_v12.py services/material_quality_guard.py services/legacy/pdf_pipeline.py
